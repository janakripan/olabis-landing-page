        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24 mb-32">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 leading-tight mb-6 tracking-tight">
              Highlight Products & <br className="hidden md:block" /> Meals
            </h2>
            <p className="text-lg text-gray-500 leading-relaxed mb-8 font-medium">
              Use the power of Ketchup Menu to <span className="text-[#BB2117] font-bold">showcase new products or dishes</span>, highlight special offers, and update your catalog instantly. <span className="text-[#BB2117] font-bold">Create a modern retail or dining experience</span> with images, videos, and customizable templates. Want to stand out? Offer interactive links and QR codes to keep customers engaged and coming back!
            </p>
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-24">
          ...
          >
            <div className="w-full max-w-[600px] mx-auto aspect-[4/2.8] bg-[#1A1A1A] rounded-[24px] lg:rounded-[32px] p-2.5 shadow-[0_30px_80px_rgba(0,0,0,0.12)] border-[4px] border-[#1A1A1A] relative overflow-clip flex gap-2">
               {/* Left Poster (Supermarket Sale) */}
               <div className="flex-1 bg-white rounded-[14px] lg:rounded-[20px] overflow-hidden relative group">
                 <img src="/supermarket_sale_banner.png" alt="Supermarket Sale Promo" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
               </div>
               
               {/* Right Poster (Discount Sale) */}
               <div className="flex-1 bg-white rounded-[14px] lg:rounded-[20px] overflow-hidden relative group">
                 <img src="/discount_sale_banner.png" alt="Discount Sale Promo" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
               </div>
            </div>
          </motion.div>
